...
<pre><font size="4">
  ...
  - Clic abajo para descargar > Archivo comprimido <b>"launch_gestion_incidencias.zip"</b> para distribución:    
      ...
      > <b>INSTRUCCIONES</b>:
          ...
          - Descomprimir y ubicar el <b>.exe</b> en la carpeta donde se desea tener la base de datos
...
[Descargar Gestor de Incidencias V2 (.zip)](https://github.com/fcojgarciafcoingeniero/primero_dam_portfolio/releases/tag/v3/launch_gestion_incidencias.zip)
